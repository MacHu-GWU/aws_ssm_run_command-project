# -*- coding: utf-8 -*-
#
# aws_ssm_run_command documentation build configuration file, created by
...
import aws_ssm_run_command as package
...
# Add data for Jinja2
try:
    from aws_ssm_run_command.docs import doc_data
except:
    doc_data = dict()
